...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "frm_question")) {
  $updateSQL = sprintf("UPDATE question SET name=%s, email=%s, question=%s, answer=%s WHERE id=%s",
                       GetSQLValueString($_POST['txt_name'], "text"),
                       GetSQLValueString($_POST['txt_email'], "text"),
                       GetSQLValueString($_POST['txt_question'], "text"),
                       GetSQLValueString($_POST['txt_answer'], "text"),
                       GetSQLValueString($_POST['name1'], "int"));

  mysql_select_db($database_register, $register);
  $Result1 = mysql_query($updateSQL, $register) or die(mysql_error());

  $updateGoTo = "manage-que.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_register, $register);
$query_rec_que = "SELECT * FROM question WHERE id = $pid";
    ...
    <td width="574" align="center" valign="top" scope="row"><div align="right" class="c">
      <div class="menu">
        <div class="bigtop" align="center">
          <div class="bigtext">پرسش و پاسخ</div>
        </div>
          <div class="bigmiddle" align="center">
                <div class="text">
                  <div align="right">
                      <div class="padd1"><br/>
                      <form action="<?php echo $editFormAction; ?>" method="POST" name="frm_question" id="frm_question">
            <table width="380" height="65" border="0" cellpadding="0" cellspacing="0">
            
              <tr>
                <td width="71" scope="row"><label for="txt_name">
                  <div align="right">&nbsp;&nbsp;نام :</div>
                </label></td>
                <td width="303" align="right">
                <input name="name1" type="hidden" value="<?php echo $row_rec_que['id']; ?>">
                  <input name="txt_name" type="text" id="txt_name" value="<?php echo $row_rec_que['name']; ?>"></td>
              </tr>
              
              <tr>
                <td width="71" scope="row"><label for="txt_email">
                  <div align="right"><br/>&nbsp;&nbsp;ایمیل :</div>
                </label></td>
                <td width="303" align="right"><br/>
                  <input name="txt_email" type="text" id="txt_email" value="<?php echo $row_rec_que['email']; ?>" ></td>
              </tr>
             
              <tr>
                <td valign="top" scope="row"><label for="txt_question">
                  <div align="right"><br/>&nbsp;&nbsp;سوال :</div>
                </label></td>
                <td align="right"><br/>
                  <textarea name="txt_question" id="txt_question" cols="45" rows="5"><?php echo $row_rec_que['question']; ?></textarea></td>
              </tr>
              <tr>
                <td valign="top" scope="row"><label for="txt_question">
                  <div align="right"><br/>&nbsp;&nbsp;پاسخ :</div>
                </label></td>
                <td align="right"><br/>
                  <textarea name="txt_answer" id="txt_answer" cols="45" rows="5"><?php echo $row_rec_que['answer']; ?></textarea></td>
              </tr>
              <tr>
                <th colspan="2" scope="row">
                <br/>
                <label>
                  <input type="submit" name="btn_sumbit" id="btn_sumbit" value="ویرایش پرسش">
                </label></th>
                </tr>
            </table>
              <input type="hidden" name="MM_insert" value="frm_question">
              <input type="hidden" name="MM_update" value="frm_question">
          </form>
                    <br/>
          <center>
            <a href="manage-que.php">برگشت</a>
          </center>
