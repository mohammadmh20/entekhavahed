    ...
    <td width="574" align="center" valign="top" scope="row"><div align="right" class="c">
      <div class="menu">
        <div class="bigtop" align="center">
          <div class="bigtext">مدیریت اخبار سایت</div>
        </div>
          <div class="bigmiddle" align="center">
                <div class="text">
                  <div align="right">
                      ...
                      <tr>
                      <td>
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../img/new.png" width="16" height="16" /> <a href="new-news.php">ارسال خبر جدید</a>                     </td>
                     </tr>
                     </table>
                     <br/>
                      <form action="" method="post" name="frm_manage-news" id="frm_manage-news">
                      <table width="450" height="65" border="1" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <th width="20" align="center" scope="row">ردیف</th>
                              <th width="238" align="center">عنوان خبر</th>
                      ...
                      <?php do { ?>
                            <tr>
                              ...
                              <td>&nbsp;<?php echo $row_rec_news['title']; ?></td>
                              <td align="center"><a href="delete-news.php?id=<?php echo $row_rec_news['id']; ?>"><img src="../img/delete.png" height="20" width="20" /></a></td>
                              <td align="center"><a href="edit-news.php?id=<?php echo $row_rec_news['id']; ?>"><img src="../img/edit.png" height="20" width="20" /></a></td>
                            </tr>
