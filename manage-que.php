...
mysql_select_db($database_register, $register);
$query_rec_que = "SELECT name, id FROM question ORDER BY id DESC";
    ...
    <td width="574" align="center" valign="top" scope="row"><div align="right" class="c">
      <div class="menu">
        <div class="bigtop" align="center">
          <div class="bigtext">مدیریت پرسش و پاسخ</div>
        </div>
          <div class="bigmiddle" align="center">
                <div class="text">
                  <div align="right">
                      <div class="padd1"> <br/>
                      <form action="" method="post" name="frm_manage-que" id="frm_manage-que">
                          <table width="450" height="65" border="1" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <th width="20" align="center" scope="row">ردیف</th>
                              <th width="238" align="center">نام</th>
                            ...
                            <?php do { ?>
                            <tr>
                              <td height="20" scope="row" align="center">&nbsp;<?php echo $counter++; ?></td>
                              <td>&nbsp;<?php echo $row_rec_que['name']; ?></td>
                              <td align="center"><a href="delete-que.php?id=<?php echo $row_rec_que['id']; ?>"><img src="../img/delete.png" height="20" width="20" /></a></td>
                              <td align="center"><a href="edit-que.php?id=<?php echo $row_rec_que['id']; ?>"><img src="../img/edit.png" height="20" width="20" /></a></td>
                            </tr>
                              <?php } while ($row_rec_que = mysql_fetch_assoc($rec_que)); ?>
                          </table>
                                                    <br/>
                          <br/>
                          <center>
