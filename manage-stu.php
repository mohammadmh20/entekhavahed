    ...
    <td width="574" align="center" valign="top" scope="row"><div align="right" class="c">
      <div class="menu">
        <div class="bigtop" align="center">
          <div class="bigtext">مدیریت دانشجویان ثبت نام شده</div>
        </div>
                        ...
                        <form action="" method="post" name="frm_manage" id="frm_manage">
                          <table width="450" height="65" border="1" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <th width="20" align="center" scope="row">عکس</th>
                              <th width="164" align="center" scope="row">نام و نام خانوادگی</th>
                              <th width="156" align="center">شماره شناسنامه</th>
                              <th width="28" align="center">حذف</th>
                              <th width="43" align="center">ویرایش</th>
                            </tr>
                            <?php $counter=1;?>
                            <?php do { ?>
                            <tr>
