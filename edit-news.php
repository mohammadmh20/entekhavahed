...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "frm_news")) {
  $updateSQL = sprintf("UPDATE news SET title=%s, little_news=%s, long_news=%s WHERE id=%s",
                       GetSQLValueString($_POST['txt_title'], "text"),
                       GetSQLValueString($_POST['txt_title_news'], "text"),
                       GetSQLValueString($_POST['txt_long_news'], "text"),
...
mysql_select_db($database_register, $register);
$query_rec_news = "SELECT * FROM news WHERE id = $pid";
    ...
    <td width="574" align="center" valign="top" scope="row"><div align="right" class="c">
      <div class="menu">
        <div class="bigtop" align="center">
          <div class="bigtext">ویرایش اخبار</div>
        </div>
          <div class="bigmiddle" align="center">
                <div class="text">
                  <div align="right">
                      <div class="padd1"> <br/>
                        <form action="<?php echo $editFormAction; ?>" method="POST" name="frm_news" id="frm_news">
                          <table width="664" border="0" cellpadding="0" cellspacing="0">
                          <input name="name1" type="hidden" value="<?php echo $row_rec_news['id']; ?>">
                            <tr>
                              <td width="80" scope="row"><label for="txt_title">&nbsp;&nbsp;عنوان خبر :</label>
                              </td>
                              <td width="584"><input name="txt_title" type="text" id="txt_title" value="<?php echo $row_rec_news['title']; ?>" size="50"></td>
                            </tr>
                            <tr>
                              <td scope="row"><br/><label for="txt_title_news">&nbsp;&nbsp;خلاصه خبر :</label>
                              </td>
                              <td><br/><textarea name="txt_title_news" id="elm2" cols="45" rows="5"><?php echo $row_rec_news['little_news']; ?></textarea></td>
                            </tr>
                            <tr>
                              <td scope="row"><br/><label for="txt_long_news">&nbsp;&nbsp;متن کامل :</label>
                              </td>
                              <td><br/><textarea name="txt_long_news" id="elm3" cols="45" rows="5"><?php echo $row_rec_news['long_news']; ?></textarea></td>
                            </tr>
                            <tr>
                          ...
                          <center><input type="submit" name="btn_submit" id="btn_submit" value="ثبت ویرایش">
                          </center>
                          <input type="hidden" name="MM_insert" value="frm_news">
                          <input type="hidden" name="MM_update" value="frm_news">
                        </form>
                        <br/>
                       <center> <a href="manage-news.php">بازگشت</a>   </center>          <br/>
                      </div>
                  </div>
                </div>
          </div>
