...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm_static")) {
  $insertSQL = sprintf("INSERT INTO staticpage (title, long_text) VALUES (%s, %s)",
...
body {
	background-image: #cdcbc6 url(../img/1px_light.png) repeat-y center top;
}
-->
</style>
    ...
    <td width="574" align="center" valign="top" scope="row"><div align="right" class="c">
      <div class="menu">
        <div class="bigtop" align="center">
          <div class="bigtext">صفحه جدید</div>
        </div>
                      ...
                      <div class="padd1"> <br/>
                          ...
                          <table width="664" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              ...
                              <td><br/><textarea name="txt_long" id="elm3" cols="45" rows="5"></textarea></td>
                            </tr>
                            <tr>
                          ...
                          <center><input type="submit" name="btn_submit" id="btn_submit" value="ساخت صفحه">
                          </center>
