...
mysql_select_db($database_register, $register);
$query_rec_static = "SELECT * FROM staticpage";
    ...
    <td width="574" align="center" valign="top" scope="row"><div align="right" class="c">
      <div class="menu">
        <div class="bigtop" align="center">
          <div class="bigtext">مدیریت صفحات استاتیک</div>
        </div>
          <div class="bigmiddle" align="center">
                <div class="text">
                  <div align="right">
                      ...
                      <tr>
                      <td>
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../img/new.png" width="16" height="16" /> <a href="new-static.php">ساخت صفحه جدید</a>                     </td>
                     </tr>
                     </table>
                     <br/>
                        <form action="" method="post" name="frm_static" id="frm_static">
                      <table width="450" height="48" border="1" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                              <th width="20" height="19" align="center" scope="row">ردیف</th>
                              <th width="238" align="center">عنوان</th>
                              <th width="150" align="center">لینک</th>
                          <th width="28" align="center">حذف</th>
                              <th width="40" align="center">ویرایش</th>
                            </tr>
                            <?php $counter=1;?>
                            <?php do { ?>
                             <tr>
                               <td height="20" scope="row">&nbsp;<?php echo $counter++; ?></td>
                               <td><?php echo $row_rec_static['title']; ?></td>
                               <td><div align="center">
                                 <input name="txt_link" type="text" value="<?php echo $row_rec_static['link']; ?><?php echo $row_rec_static['id']; ?>" readonly >
                               </div></td>
                               <td align="center"><a href="delete-static.php?id=<?php echo $row_rec_static['id']; ?>"><img src="../img/delete.png" height="20" width="20" /></a></td>
                               <td align="center"><a href="edit-static.php?id=<?php echo $row_rec_static['id']; ?>"><img src="../img/edit.png" height="20" width="20" /></a></td>
                             </tr>
                              <?php } while ($row_rec_static = mysql_fetch_assoc($rec_static)); ?>
                         </table>
                                                    <br/>
                          <br/>
                          <center>
