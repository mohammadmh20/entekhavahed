...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm_news")) {
  $insertSQL = sprintf("INSERT INTO news (title, little_news, long_news) VALUES (%s, %s, %s)",
    ...
    <td width="574" align="center" valign="top" scope="row"><div align="right" class="c">
      <div class="menu">
        <div class="bigtop" align="center">
          <div class="bigtext">اخبار جدید</div>
        </div>
                        ...
                        <form action="<?php echo $editFormAction; ?>" method="POST" name="frm_news" id="frm_news">
                          <table width="664" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td width="584"><input type="text" name="txt_title" id="txt_title" size="50"></td>
                            </tr>
                            <tr>
                              <td scope="row"><br/><label for="txt_title_news">&nbsp;&nbsp;خلاصه خبر :</label>
                                </td>
                              <td><br/><textarea name="txt_title_news" id="elm2" cols="45" rows="5"></textarea></td>
                            </tr>
                            <tr>
                              <td scope="row"><br/><label for="txt_long_news">&nbsp;&nbsp;متن کامل :</label>
                              </td>
                              <td><br/><textarea name="txt_long_news" id="elm3" cols="45" rows="5"></textarea></td>
                            </tr>
                            <tr>
                          ...
                          <center><input type="submit" name="btn_submit" id="btn_submit" value="ارسال خبر"></center>
